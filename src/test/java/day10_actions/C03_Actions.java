...
public class C03_Actions extends TestBase {
    ...
    public void test01() {
        ...
        WebElement cizgiliAlanElementi = driver.findElement(By.xpath("hot-spot"));
        ...
        String actuelIkinciYazi = yaziElementi.getText();

        Assert.assertEquals(expectedikinciYazi,actuelIkinciYazi);
